...
class _LekHomeState extends State<LekHome>
  ...
  Future<void> _exportCurrentFormCsv() async {
    ...
    try {
      final doc = await FirestoreDb.db.collection('lek_forms').doc(widget.formId).get();
  ...
  Widget build(BuildContext context) {
    final topItems = <_GridItem>[
      ...
      _GridItem(
        ...
        onTap: () => _open(
          InfoPage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
      ...
      _GridItem(
        ...
        color: const Color(0xFF00B8B8),
        onTap: () => _open(
          DynamiqueDuCrabePage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
        ...
        color: const Color(0xFF00B8B8),
        onTap: () => _open(
          ImpactEcologiquePage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
        ...
        color: const Color(0xFF00B8B8),
        onTap: () => _open(
          ImpactSurLaPechePage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
        ...
        color: const Color(0xFF00B8B8),
        onTap: () => _open(
          AdaptationLocalePage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
        ...
        color: const Color(0xFF00B8B8),
        onTap: () => _open(
          EtatDesLieuxPage(formId: widget.formId, data: _data)),
      ),
      _GridItem(
        ...
        onTap: () => _open(
          NiveauDeConfiancePage(formId: widget.formId, data: _data),
        ),
      ),
    ];
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData && snapshot.data!.data() != null) {
                      ...
                      return Container(
                        ...
                        child: Text(
                          'Statut : $status | Progression : $step/9',
